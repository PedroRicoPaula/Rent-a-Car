...
session_start();
/* Verificar se já existe reservas nas datas selecionadas no formulário anterior */
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<header class="header">
    ...
    <div class="formCreateClient">
        <h1>Criar Cliente</h1>
    <form action="verifyClientFormReservation.php" method="post" class="formClient">
